...
// console.log(<DifferentContent />); // It's react element instance. has type of DifferentContent()
// console.log(DifferentContent()); // has type of <div>, the content of that component, React doesn't treat it as a component instance.
...
function Tabbed({ content }) {
  ...
  return (
    <div>
      ...
      {activeTab <= 2 ? (
        //add key prop to TabContent to reset state when switching tabs
